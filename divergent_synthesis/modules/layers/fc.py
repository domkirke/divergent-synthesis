...
from divergent_synthesis.modules import calculate_gain
from divergent_synthesis.utils import checklist, checktuple
...
class MLP(nn.Module):
    ...
    def __init__(self, input_dim: int, output_dim: int, nlayers: int = 1,
        ...
        layers = []
        layer_class = mlp_hash.get('layer', self.Layer)
